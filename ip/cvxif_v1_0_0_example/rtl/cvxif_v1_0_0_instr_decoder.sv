...
module cvxif_v1_0_0_instr_decoder #(
  ...
  logic rs2_ready;
  logic rs3_ready;
  logic [NbInstr-1:0][31:0] AND_RESULT;

    for (genvar i = 0; i < NbInstr; i++) begin : gen_and_result
    assign AND_RESULT[i] = ((CoproInstr[i].mask & issue_req_i.instr));
  end
