...
#define SAFE_WRAPPER_CTRL_EXTERNAL_DEBUG_REQ_REG_OFFSET 0x14
...
#define SAFE_WRAPPER_CTRL_INITIAL_SYNC_MASTER_REG_OFFSET 0x18
#define SAFE_WRAPPER_CTRL_INITIAL_SYNC_MASTER_INITIAL_SYNC_MASTER_BIT 0

// End_SW_Routine
#define SAFE_WRAPPER_CTRL_END_SW_ROUTINE_REG_OFFSET 0x1c
#define SAFE_WRAPPER_CTRL_END_SW_ROUTINE_END_SW_ROUTINE_BIT 0

// Entry_Address
#define SAFE_WRAPPER_CTRL_ENTRY_ADDRESS_REG_OFFSET 0x20

// Safe_Copy_Address
#define SAFE_WRAPPER_CTRL_SAFE_COPY_ADDRESS_REG_OFFSET 0x24

// Interrupt_Controler
#define SAFE_WRAPPER_CTRL_INTERRUPT_CONTROLER_REG_OFFSET 0x28
...
// EROS_STATUS
#define SAFE_WRAPPER_CTRL_EROS_STATUS_REG_OFFSET 0x2c
#define SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_SLEEP_MASK 0x7
#define SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_SLEEP_OFFSET 0
#define SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_SLEEP_FIELD \
  ((bitfield_field32_t) { .mask = SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_SLEEP_MASK, .index = SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_SLEEP_OFFSET })
#define SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_DEBUG_MODE_MASK 0x7
#define SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_DEBUG_MODE_OFFSET 3
#define SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_DEBUG_MODE_FIELD \
  ((bitfield_field32_t) { .mask = SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_DEBUG_MODE_MASK, .index = SAFE_WRAPPER_CTRL_EROS_STATUS_CORES_DEBUG_MODE_OFFSET })

// DMR_REC
#define SAFE_WRAPPER_CTRL_DMR_REC_REG_OFFSET 0x30
#define SAFE_WRAPPER_CTRL_DMR_REC_DMR_REC_BIT 0

// DMR_REC
#define SAFE_WRAPPER_CTRL_INITIAL_STACK_ADDR_REG_OFFSET 0x34

// Switch_Context_Address
#define SAFE_WRAPPER_CTRL_PREEMPTIVE_CONTEXT_ADDRESS_REG_OFFSET 0x38

// Switch_Context_Address
#define SAFE_WRAPPER_CTRL_PREEMPTIVE_CONTROL_STATUS_REG_OFFSET 0x3c
#define SAFE_WRAPPER_CTRL_PREEMPTIVE_CONTROL_STATUS_PREEMPTIVE_TRIGGER_BIT 0
#define SAFE_WRAPPER_CTRL_PREEMPTIVE_CONTROL_STATUS_PREEMPTIVE_READY_BIT 1
#define SAFE_WRAPPER_CTRL_PREEMPTIVE_CONTROL_STATUS_PREEMPTIVE_CONTINUE_BIT 2
