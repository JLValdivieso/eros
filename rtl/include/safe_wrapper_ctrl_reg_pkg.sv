...
package safe_wrapper_ctrl_reg_pkg;
  ...
  } safe_wrapper_ctrl_hw2reg_eros_status_reg_t;
  ...
  parameter logic [BlockAw-1:0] SAFE_WRAPPER_CTRL_EXTERNAL_DEBUG_REQ_OFFSET = 6'h 14;
  parameter logic [BlockAw-1:0] SAFE_WRAPPER_CTRL_INITIAL_SYNC_MASTER_OFFSET = 6'h 18;
  ...
  parameter logic [BlockAw-1:0] SAFE_WRAPPER_CTRL_SAFE_COPY_ADDRESS_OFFSET = 6'h 24;
  parameter logic [BlockAw-1:0] SAFE_WRAPPER_CTRL_INTERRUPT_CONTROLER_OFFSET = 6'h 28;
  ...
  parameter logic [3:0] SAFE_WRAPPER_CTRL_PERMIT [14] = '{
    ...
    4'b 0001, // index[ 5] SAFE_WRAPPER_CTRL_EXTERNAL_DEBUG_REQ
    4'b 0001, // index[ 6] SAFE_WRAPPER_CTRL_INITIAL_SYNC_MASTER
    4'b 0001, // index[ 7] SAFE_WRAPPER_CTRL_END_SW_ROUTINE
    4'b 1111, // index[ 8] SAFE_WRAPPER_CTRL_ENTRY_ADDRESS
    4'b 1111, // index[ 9] SAFE_WRAPPER_CTRL_SAFE_COPY_ADDRESS
