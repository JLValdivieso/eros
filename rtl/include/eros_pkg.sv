...
package eros_pkg;
  ...
  localparam int unsigned NCYCLES = 1;
  ...
  localparam int unsigned NMASTER_COPROC = 1;
  localparam int unsigned NMASTER_ACC = 0;
  ...
  localparam GLOBAL_BASE_ADDRESS = 32'h03040000;
  localparam SAFE_CSR_BASE_ADDRESS = 32'h03070000; /*core_v_mini_mcu_pkg::EXT_PERIPHERAL_START_ADDRESS;*/
  ...
  localparam logic [31:0] EXTERNAL_PERIPHERAL_START_ADDRESS = 32'h03042000;/*X-HEEP VERSION32'h00000000;*/
